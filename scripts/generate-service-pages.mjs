...
const servicePages = [
  {
    ...
    sections: [
      ...
      ["서울·경기·인천 이용 가능 지역 안내", "간다GO는 전국 키워드를 넓게 다루기보다 서울, 경기, 인천 지역을 중심으로 실제 운영 가능한 권역을 안내합니다. 세부 행정구역은 지역별 찾기 메뉴에서 확인하고, 서비스 안내 페이지에서는 관리 유형과 예약 기준을 중심으로 살펴보면 좋습니다."],
